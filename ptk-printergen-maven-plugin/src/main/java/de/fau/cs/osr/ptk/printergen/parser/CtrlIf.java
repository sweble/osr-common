	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return CtrlIf.this.getCond();
					case 1:
						return CtrlIf.this.getIndent();
					case 2:
						return CtrlIf.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return CtrlIf.this.setCond((String) value);
					case 1:
						return CtrlIf.this.setIndent((String) value);
					case 2:
						return CtrlIf.this.setIndented((Boolean) value);
