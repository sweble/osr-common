	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return CtrlIfEnd.this.getIndent();
					case 1:
						return CtrlIfEnd.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return CtrlIfEnd.this.setIndent((String) value);
					case 1:
						return CtrlIfEnd.this.setIndented((Boolean) value);
