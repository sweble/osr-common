	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return CtrlCall.this.getTarget();
					case 1:
						return CtrlCall.this.getIndent();
					case 2:
						return CtrlCall.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return CtrlCall.this.setTarget((String) value);
					case 1:
						return CtrlCall.this.setIndent((String) value);
					case 2:
						return CtrlCall.this.setIndented((Boolean) value);
