	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return CtrlElse.this.getIndent();
					case 1:
						return CtrlElse.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return CtrlElse.this.setIndent((String) value);
					case 1:
						return CtrlElse.this.setIndented((Boolean) value);
