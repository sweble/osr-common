        ...
        implements Instruction
{
	...
	public final String setStmt(String stmt)
	{
		String old = this.stmt;
		this.stmt = stmt;
		return old;
	}
	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return Stmt.this.getStmt();
					case 1:
						return Stmt.this.getIndent();
					case 2:
						return Stmt.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return Stmt.this.setStmt((String) value);
					case 1:
						return Stmt.this.setIndent((String) value);
					case 2:
						return Stmt.this.setIndented((Boolean) value);
