        ...
        implements Instruction
{
	...
	public final String setCond(String cond)
	{
		String old = this.cond;
		this.cond = cond;
		return old;
	}
	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return CtrlElif.this.getCond();
					case 1:
						return CtrlElif.this.getIndent();
					case 2:
						return CtrlElif.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return CtrlElif.this.setCond((String) value);
					case 1:
						return CtrlElif.this.setIndent((String) value);
					case 2:
						return CtrlElif.this.setIndented((Boolean) value);
