	...
	public final AstNodePropertyIterator propertyIterator()
	{
		return new AstNodePropertyIterator()
		{
			...
			protected Object getValue(int index)
			{
				...
				{
					case 0:
						return CtrlCallEnd.this.getIndent();
					case 1:
						return CtrlCallEnd.this.getIndented();
			...
			protected Object setValue(int index, Object value)
			{
				...
				{
					case 0:
						return CtrlCallEnd.this.setIndent((String) value);
					case 1:
						return CtrlCallEnd.this.setIndented((Boolean) value);
